...
<div class="sidebar">
    ...
    <ul class="nav-list" style="padding-left:0;">
      ...
      <li>
     <li>
       <a href="{{ route('student.page' , 'lecture') }}">
     ...
     <li>
       <a href="{{ route('student.page' , 'lesson') }}">
     ...
     <li>
      <a href="{{ route('student.page' , 'announcement') }}">
     ...
     {{-- <li>
      <a href="{{ route('student.page' , 'profile') }}">
